...
interface StressfulLifeEventsProps {
  data: any
  updateData: (data: any) => void
}

export default function StressfulLifeEvents({ data, updateData }: StressfulLifeEventsProps) {
    ...
    <div className="space-y-8">
      <div className="text-center mb-6">
        ...
        <p className="mt-2 text-gray-600">
          Below is an assessment of stressful life events based on the research done by Drs. Holmes and Rahe. It is
          designed to assess possible health risks, based on the things that have happened in your life in the last
          year.
        </p>
        <p className="mt-2 text-gray-600">
          Below are a variety of possible normal yet stressful events. Add up the numbers on the right of each event
          that has occurred in your life in the last 12 months.
        </p>
      </div>
        ...
        <CardContent>
          ...
          <div className="mt-8 p-4 bg-blue-50 rounded-lg">
            ...
            <p className="mt-4 text-sm text-gray-600">
              These predictions are not absolute. Health changes are the result of many different factors, including how
              significant those life events are to you, your personal capacity to cope with stress and life changes, and
              the available support through family, work and friends.
            </p>
            <p className="mt-2 text-sm text-gray-600">
              However, taking this quiz can give you some insight to potential risk to your health and well-being so you
              can take measures to take care of yourself.
            </p>
          </div>
        </CardContent>
      </Card>
